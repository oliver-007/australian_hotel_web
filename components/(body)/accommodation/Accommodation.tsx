            ...
            acd.map(({ bg, title }, index) => (
              ...
              >
                ...
                <div className="w-full relative  h-full group flex flex-col items-center justify-center  ">
                  <div className="bg-yellow-300/80  capitalize  w-full md:group-hover:-translate-y-[93px] lg:group-hover:-translate-y-[131px] md:mt-23 h-10 group-hover:transition-transform duration-500 ease-in-out flex items-center justify-center ">
                  ...
                  <div className=" opacity-0 md:group-hover:opacity-100 md:scale-0 md:group-hover:scale-100 md:group-hover:transition-all duration-500 ease-in-out md:flex flex-col md:gap-y-1 md:mb-8 md:origin-center   ">
